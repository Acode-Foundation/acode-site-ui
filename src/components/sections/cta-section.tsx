import { ArrowRight, Download, Play, ExternalLink } from "lucide-react"
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="bg-card/30 backdrop-blur-sm border border-border rounded-2xl p-8 mb-12 relative group hover:border-primary/30 transition-colors">
            <div className="absolute top-4 right-4">
              <span className="text-xs text-muted-foreground bg-secondary/50 px-2 py-1 rounded">Sponsored</span>
            </div>
          ...
          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: "0.2s" }}>
            Join thousands of developers who are already coding on the go with Acode. 
            Download now and transform your mobile device into a powerful development environment.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-slide-up" style={{ animationDelay: "0.4s" }}>
            <Button size="lg" className="bg-gradient-primary hover:shadow-glow-primary transition-all duration-300 group min-w-[200px]">
              <Play className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" />
              Get on Play Store
              <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
            </Button>
            
            <Button variant="outline" size="lg" className="border-border hover:bg-secondary/50 group min-w-[200px]">
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <div>
