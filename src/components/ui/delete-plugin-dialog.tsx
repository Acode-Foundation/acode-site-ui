...
export const DeletePluginDialog = forwardRef<
	HTMLDivElement,
	DeletePluginDialogProps
>(
	(
		{ pluginName, isOwner, isAdmin, onDelete, trigger, isDeleting = false },
		ref,
	) => {
											...
											>
												<div className="flex items-start space-x-3">
													...
													<div className="space-y-1 min-w-0">
														<Label
															htmlFor="soft"
															className="font-medium text-sm text-left block"
														>
															Soft Delete
														</Label>
														<p className="text-xs text-muted-foreground leading-relaxed text-left">
															Marks the plugin as deleted but keeps the data.
												...
												<div className="flex items-start space-x-3">
													...
													<div className="space-y-1 min-w-0">
														<Label
															htmlFor="hard"
															className="font-medium text-destructive text-sm text-left block"
														>
															Hard Delete
														</Label>
														<p className="text-xs text-muted-foreground leading-relaxed text-left">
...
DeletePluginDialog.displayName = "DeletePluginDialog";
