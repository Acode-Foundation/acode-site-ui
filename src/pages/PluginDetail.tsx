              ...
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="secondary" className="text-sm px-3 py-1 hover:bg-primary/20 hover:text-primary hover:border-primary/30 transition-colors">
                      v{plugin.version}
                    </Badge>
                    <Badge 
                      variant="secondary" 
                      className={`text-sm px-3 py-1 transition-colors ${
                        plugin.price === 0 
                          ? 'text-green-500 hover:text-green-600 hover:bg-green-500/20 hover:border-green-500/30' 
