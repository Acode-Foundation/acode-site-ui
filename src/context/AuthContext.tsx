...
export function AuthProvider({ children }) {
	...
	const updateProfile = async (
		...
		if (
			...
			(emailOtp && typeof emailOtp !== "number")
		)
			throw Error(
				`[updateProfile] Params used must be: 'formData' as FormData, 'handleRedirect' as a typeof Function, (optionally) emailOTP? as a number`,
			);
